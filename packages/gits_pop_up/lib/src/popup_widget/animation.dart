...
Widget notificationAnimation(AnimationController controller,
        CancelFunction cancelFunction, Widget child) =>
    NormalAnimation(reverse: true, controller: controller, child: child);

Widget textAnimation(AnimationController controller,
        CancelFunction cancelFunction, Widget child) =>
    NormalAnimation(controller: controller, child: child);

Widget loadingAnimation(AnimationController controller,
        CancelFunction cancelFunction, Widget child) =>
    FadeAnimation(controller: controller, child: child);

Widget attachedAnimation(AnimationController controller,
        CancelFunction cancelFunction, Widget child) =>
    FadeAnimation(controller: controller, child: child);
